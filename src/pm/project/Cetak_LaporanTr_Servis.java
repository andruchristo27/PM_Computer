 ...
 * @author Rayhan
 */
public class Cetak_LaporanTr_Servis extends javax.swing.JFrame {

    /**
     * Creates new form Cetak_LaporanTransaksi
     */
    public Cetak_LaporanTr_Servis() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pm/project/PROPERTI/bg cetakservis.png"))); // NOI18N
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        try {
            ...
            InputStream report = getClass().getResourceAsStream("Report servis.jasper");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cetak_LaporanTr_Servis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cetak_LaporanTr_Servis().setVisible(true);
            }
        });
    }
